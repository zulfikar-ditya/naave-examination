        ...
        <table class="table table-responsive">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <div class="">
                            <x-btn-link :link="route('company.show', $item)" :color="'info'" :value="'Detail'"/>
                            <x-btn-link :link="route('company.edit', $item)" :color="'warning'" :value="'Edit'"/>
                            <x-btn-link :link="'#'" :color="'danger'" :value="'Delete'" :id="'btn-delete-'.$item->id"/>
                            <form action="{{route('company.destroy', $item)}}" id="form-delete-{{$item->id}}" method="POST">
                                @csrf
                                @method('DELETE')
                            </form>
                        </div>
